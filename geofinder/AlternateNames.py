...
from geofinder import GeodataFiles, GeoUtil, GeoDB, Loc
...
class AlternateNames(FileReader):
    ...
    def read(self) -> bool:
        # Do entire file as one DB transaction
    ...
    def handle_line(self, line_num, row):
        """
        For each line in file, add item to alternate name DB if we are supporting that language
